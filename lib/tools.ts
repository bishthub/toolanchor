...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: "View an image's hidden EXIF metadata online — camera, date, settings and GPS location. A free exif viewer that runs in your browser. No upload.",
    keywords: ["image metadata viewer", "exif viewer", "exif data viewer", "exiftool online", "metadata checker", "check image metadata", "see image metadata", "photo metadata", "png metadata viewer", "gps from photo", "image metadata reader"],
  ...
  },
  {
    ...
    keywords: ["passport photo maker", "passport photo crop", "us passport photo cropping tool", "crop passport size photo", "passport size photo", "visa photo crop", "2x2 photo maker", "passport photo online free", "id photo maker"],
  ...
  {
    slug: "readability-checker", name: "Readability Checker", category: "text", status: "live", trending: true,
    description: "Check the readability score of any text with Flesch-Kincaid, Gunning Fog, SMOG and Coleman-Liau indexes. Free AI text analysis tool — runs in your browser, no upload.",
    keywords: ["readability checker", "readability score", "flesch kincaid", "text readability", "grade level checker", "reading ease"],
    answer: "A readability checker scores how easy your text is to read using standard formulas: Flesch Reading Ease (0–100, higher = easier), Flesch-Kincaid Grade Level (US school grade), Gunning Fog, SMOG and Coleman-Liau. It also estimates reading time. All formulas run in your browser — no text is uploaded.",
    intro: "Readability Checker scores your text against five standard readability formulas: Flesch Reading Ease, Flesch-Kincaid Grade Level, Gunning Fog Index, SMOG Index and Coleman-Liau Index. It also counts sentences, syllables, complex words and estimates reading time.",
    ...
    faqs: [
      ...
      { q: "How does Flesch-Kincaid work?", a: "It calculates grade level from average sentence length and average syllables per word. Grade 8 = easy to read for most adults." },
      { q: "Is my text uploaded?", a: "No — everything runs in your browser. Your text never leaves your device." }
    ],
    related: ["word-counter", "character-counter", "sentiment-analyzer"],
  },
  {
    slug: "keyword-extractor", name: "Keyword Extractor / Text Word Analyzer", category: "text", status: "live", trending: true,
    description: "Extract the most important keywords and key phrases from any text with frequency and relevance scores. Free AI text analysis — runs in your browser, no upload.",
    keywords: ["keyword extractor", "extract keywords", "keyword analyzer", "text keyword tool", "important words extractor", "key phrase extractor"],
    answer: "A keyword extractor identifies the most significant words and phrases in a text by scoring each one with TF-IDF analysis — words that appear frequently but are rare across general language rank highest. It filters common stop words, considers n-gram phrases, and shows a ranked list. Everything runs in your browser.",
    intro: "Keyword Extractor finds the most important words and phrases in any text using TF-IDF scoring. It filters out common stop words, detects multi-word phrases, and ranks results by relevance. Great for SEO content analysis, article summarisation and topic discovery.",
    ...
    related: ["word-frequency-counter", "text-summarizer", "sentiment-analyzer"],
  },
  {
  ...
  {
    slug: "headline-analyzer", name: "Headline / Title Analyzer", category: "text", status: "live", trending: true,
    description: "Score your headline or title for emotional impact, word balance, length and readability. Free AI headline analyzer — runs in your browser, no upload.",
    keywords: ["headline analyzer", "title analyzer", "headline scorer", "headline checker", "emotional headline value", "coschedule alternative"],
    answer: "A headline analyzer scores your headline or title on multiple dimensions: word balance (common, uncommon, emotional, power words), length, character count, sentiment and readability. It gives a 0–100 score and specific suggestions to improve click-through rate. Everything runs in your browser — no data is uploaded.",
    intro: "Headline Analyzer scores your headlines and titles across word balance, emotional impact, length and readability. Get a 0–100 score and specific ways to improve your headline for better clicks. Used by content marketers, copywriters and bloggers.",
    ...
    related: ["serp-preview", "slug-generator", "prompt-generator"],
  },
  ...
  },
  {
    ...
    description: "Pick one or more random winners from a list of names. Fair, crypto-secure draws for giveaways, raffles and classrooms — free, instant, in-browser.",
    keywords: ["random name picker", "name picker wheel", "pick a random winner", "random winner generator", "raffle name picker"],
